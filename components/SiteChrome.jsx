...
export function Footer(){return <footer className="bg-[#10231D] text-white"><div className="shell py-14"><div className="grid gap-10 md:grid-cols-4">
 <div className="md:col-span-2"><div className="flex items-center gap-3"><div className="p-2"><Image src="/isnad-logo-4.png" alt="Isnad Institute" width={60} height={60} className="h-12 w-12 object-contain"/></div><strong className="tracking-[.12em]">ISNAD INSTITUTE</strong></div><p className="mt-5 max-w-md text-sm leading-7 text-white/65">Authentic knowledge. Modern learning. Live online Arabic and Quran education for children and adults worldwide.</p><div className="mt-5 flex flex-col items-start gap-3"><a className="inline-flex items-center gap-2 text-sm font-semibold text-white/80 hover:text-white" href="mailto:hello@isnadinstitute.com"><Mail className="h-4 w-4"/>hello@isnadinstitute.com</a><a className="inline-flex items-center gap-2 text-sm font-semibold text-white/80 hover:text-white" href="tel:+14375009885"><Phone className="h-4 w-4"/>+1 (437) 500-9885</a><a className="inline-flex items-center gap-2 text-sm font-semibold text-white/80 hover:text-white" href="https://wa.me/14375009885" target="_blank" rel="noopener noreferrer"><MessageCircle className="h-4 w-4"/>WhatsApp</a></div></div>
